...
## v0.9.0
- feat: add 'P' shortcut to quickly toggle the prompt view in active panels
- feat: enable multi-selection favored toggling with 'F' key in grid view
- feat: persist folder grid aspect ratio and layout settings across app restarts
